...
const attacks = [
    { value: 1, label: 'Dos/DDoS', trigger: '83' },
    { value: 2, label: 'Kradzież tożsamośći', trigger: '83' },
    { value: 3, label: 'Ransomware', trigger: '86' },
    { value: 4, label: 'Spyware', trigger: '83' },
    { value: 5, label: 'Adware', trigger: '83' },
...
const steps = [
    ...
    {
        id: '81',
        message: 'Jakiemu atakowi uległ Pan Marek?',
        trigger: '82',
    },
    {
        id: '82',
